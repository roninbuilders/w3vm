...
export function initEthers(){
  ...
  initQueriesStore({
    writeContract: async(params)=>{
      ...
      const contractInstance = helpers.getContractInstance({ abi: params.abi, contractAddress: params.address, chainId: chainId?.toString() as string })
    ...
    readContract: async(params)=>{
      ...
      const contractInstance = helpers.getContractInstance({ abi: params.abi, contractAddress: params.address, chainId: chainId.toString() })
